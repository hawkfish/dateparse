...
\usepackage[left=1.75cm, right=1.75cm, top=2cm]{geometry}
...
\begin{titlepage}
   \begin{center}
       \vspace*{1cm}
  \includegraphics[width=0.3\textwidth]{figures/tableau}
     \vspace*{1cm}
 
        \Large       
 \textbf{Does Anybody Really Know What Time It Is?\\
Automating the Extraction of Date Scalars}\\
 TR \#2018-01
       \vspace{1cm}
 
\large
\textbf{Richard Wesley\\
Vidya Setlur\\
Dan Cory} 
     %  \vfill
...
Tableau Software All rights reserved.\\
The information contained in this document is the exclusive property of Tableau.
This work is protected under United States copyright law and other international copyright treaties and conventions.No part of this work may be reproduced, used, or transmitted in any form or by any means except as expressly permitted in writing by Tableau.\\
All requests should be sent to Attention: Tableau Legal \href{mailto:legal@tableau.com}{legal@tableau.com} 
 \end{center}
\end{titlepage}
...
\blfootnote{\tiny{Copyright \copyright 2018\\
Tableau Software All rights reserved.\\
The information contained in this document is the exclusive property of Tableau.
This work is protected under United States copyright law and other international copyright treaties and conventions.No part of this work may be reproduced, used, or transmitted in any form or by any means except as expressly permitted in writing by Tableau.\\
All requests should be sent to Attention: Tableau Legal \href{mailto:legal@tableau.com}{legal@tableau.com}}}
