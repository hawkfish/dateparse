...
\subsection{Domains}
\vidya{Explain what you mean by domain.}
...
\vidya{can you provide brief examples for each of these functions so I can understand what they are?}
\begin{itemize}
...
In our approach, we implement all of these functions, but with significant changes to the last one, which we will describe below.\vidya{can you briefly explain why we significantly change the last one here?}
